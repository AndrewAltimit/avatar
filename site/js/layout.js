...
const NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: 'reference/unity-yaml-edit.html',   text: 'Editing Unity YAML', key: 'reference/unity-yaml-edit' },
      { href: 'reference/unity-asset.html',       text: 'Typed asset readers', key: 'reference/unity-asset' },
      { href: 'reference/migrate.html',           text: 'SDK2 → SDK3 migration', key: 'reference/migrate' },
      { href: 'reference/physbone.html',          text: 'PhysBone tuning',  key: 'reference/physbone' },
      { href: 'reference/render.html',            text: 'Rendering & preview', key: 'reference/render' },
      { href: 'reference/unitypackage.html',      text: 'The .unitypackage format', key: 'reference/unitypackage' },
      ...
      { href: 'reference/mcp.html',               text: 'MCP server',       key: 'reference/mcp' },
      { href: 'reference/testing.html',           text: 'Testing & fixtures', key: 'reference/testing' },
    ],
  },
];
