...
| [`docs/reference/physbone.md`](docs/reference/physbone.md) | `avatar physbone list|set|split|stretch|flare`: inspect + retune a prefab's PhysBones in place (curves, split, stretch, re-angle) and preview the prefab's pose with `avatar render --pose`. |
