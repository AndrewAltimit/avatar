...
| [`docs/reference/physbone.md`](docs/reference/physbone.md) | `avatar physbone list|set|split|stretch`: inspect + retune a prefab's PhysBones in place (curves, split, stretch) and preview a stretch with `avatar render --stretch`. |
